...
const CategoryList = () => {
  ...
  const { categories, isLoading } = useSelector((state) => state.form);
  ...
  const delCategory = async (cat_id) => {
    console.log(`cat_id in delCategory :`,cat_id);
  ...
  const confirmDelete = (id) => {  
    console.log(`id in confirmDelete :`,id);
    confirmAlert({
                  ...
                  {categories?.map((cat, index) => {
                    ...
                    return (
                      <tr key={_id}>
                        ...
                        >
                          <EditDailog id={_id} category={category} />
